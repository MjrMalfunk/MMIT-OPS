...
<div class="card" style="padding:16px;overflow:auto;"><h2 style="margin:0 0 12px;font-size:18px;">Bill register</h2><table style="width:100%;border-collapse:collapse;"><thead><tr style="text-align:left;border-bottom:1px solid rgba(255,255,255,.10)"><th style="padding:10px 8px;">Vendor</th><th style="padding:10px 8px;">Business line</th><th style="padding:10px 8px;">Due</th><th style="padding:10px 8px;">Status</th><th style="padding:10px 8px;">Posting</th><th style="padding:10px 8px;text-align:right;">Total</th><th style="padding:10px 8px;">Receipts</th><th style="padding:10px 8px;">Action</th></tr></thead><tbody>
<?php if (!$bills): ?><tr><td colspan="8" style="padding:18px 8px;opacity:.75;">No bills entered yet.</td></tr><?php else: foreach ($bills as $bill): ?><?php
