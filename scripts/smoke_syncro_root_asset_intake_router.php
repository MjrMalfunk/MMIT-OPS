...
foreach ([['client' => $protectClient, 'asset_id' => 118, 'label' => 'Protect', 'id' => '2002', 'write_label' => 'Protect IT'], ['client' => $manageClient, 'asset_id' => 119, 'label' => 'Manage', 'id' => '2001', 'write_label' => 'Manage IT'], ['client' => $governClient, 'asset_id' => 120, 'label' => 'Govern', 'id' => '2003', 'write_label' => 'Govern IT']] as $case) {
    $optionCalls = [];
    $optionProperties = [];
